# Version V4_5: Implementation of charts (in progress/preparation)
...
def diagramm():
    ...
    <body>
       <div class="box">
        ...
        <hr>
        <h3>Beispiel: Temperatur/Co2 Verlauf</h3>
        <img src="/diagramme/temp" 
             alt="Temperaturverlauf"
...
def temp():
    return send_file(
        "/mnt/ssd/diagramme/beispiel.png",
        mimetype="image/png"
    )
