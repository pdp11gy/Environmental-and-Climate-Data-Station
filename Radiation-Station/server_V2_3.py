# Version V2_3: Strahlenstation implementiert, zusätzlich mit UV-Sensor
# Version V2_2: Änderungen der Speicherart, siehe def save_data(data)
# Pfad: /mnt/ssd/data/ 
#                └─ 2026_KW24/
#                   └─ 2026-06-15/
#                      └─ daten.json
# Server programm für Raspberry PI zero (2)W, Wetterstation Projekt
# Support für MH-Z19C(CO2), SDS011(Feinstaub)
#             WS3(Luft+Wasser+Temperatur) 	@Wetterstation-1
#             RadiationD-V1.1 (CAJOE) + bmp280  @ Beide
#             BME680(Luft+Temeratur)            @Wetterstation-2
#  Projekt Referenz mit ChatGPT:  CHAPDP11GY-ENV-PICO-2025
